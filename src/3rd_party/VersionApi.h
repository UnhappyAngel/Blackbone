...
BLACKBONE_API inline void InitVersion()
{
    ...
    if (g_WinVer.native.dwMajorVersion != 0)
    {
        ...
        case _WIN32_WINNT_WIN10:
            if (g_WinVer.native.dwBuildNumber >= Build_Win11Beta)
                g_WinVer.ver = Win11_Beta;
...
VERSIONHELPERAPI
IsWindows11BetaOrGreater()
{
    return IsWindowsVersionOrGreater(HIBYTE(_WIN32_WINNT_WIN10), LOBYTE(_WIN32_WINNT_WIN10), 0, Build_Win11Beta);
}
